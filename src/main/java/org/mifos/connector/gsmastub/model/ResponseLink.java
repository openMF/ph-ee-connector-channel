...
public class ResponseLink {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.linkReference, responseLink.linkReference)
                ...
                && Objects.equals(this.mode, responseLink.mode) && Objects.equals(this.status, responseLink.status)
                ...
                && Objects.equals(this.requestDate, responseLink.requestDate) && Objects.equals(this.customData, responseLink.customData);
    }

    @Override
    public int hashCode() {
        return Objects.hash(linkReference, sourceAccountIdentifiers, mode, status, requestingOrganisation, creationDate, modificationDate,
