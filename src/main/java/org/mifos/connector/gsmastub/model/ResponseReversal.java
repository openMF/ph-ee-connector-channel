...
public class ResponseReversal {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.transactionReference, responseReversal.transactionReference)
                && Objects.equals(this.requestingOrganisationTransactionReference,
                        responseReversal.requestingOrganisationTransactionReference)
                ...
                && Objects.equals(this.debitParty, responseReversal.debitParty) && Objects.equals(this.type, responseReversal.type)
                ...
                && Objects.equals(this.amount, responseReversal.amount) && Objects.equals(this.currency, responseReversal.currency)
                && Objects.equals(this.descriptionText, responseReversal.descriptionText)
                && Objects.equals(this.fees, responseReversal.fees) && Objects.equals(this.geoCode, responseReversal.geoCode)
                ...
                && Objects.equals(this.customData, responseReversal.customData) && Objects.equals(this.metadata, responseReversal.metadata)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(transactionReference, requestingOrganisationTransactionReference, originalTransactionReference, creditParty,
                debitParty, type, subType, transactionStatus, amount, currency, descriptionText, fees, geoCode, requestingOrganisation,
                servicingIdentity, transactionReceipt, creationDate, modificationDate, requestDate, customData, metadata, dateCreated,
                dateModified, receivingLei, requestingLei);
    }
