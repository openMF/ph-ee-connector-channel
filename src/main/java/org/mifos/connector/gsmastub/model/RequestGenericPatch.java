...
public class RequestGenericPatch {
    ...
    /**
     * Indicates the Patch operation to be performed. 'replace' is used to update a field and 'add' is used to add a new
     * field.
     */
    public enum OpEnum {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.op, requestGenericPatch.op) && Objects.equals(this.path, requestGenericPatch.path)
