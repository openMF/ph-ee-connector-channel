...
public class ResponseDebitMandate {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(mandateReference, payee, mandateStatus, startDate, amountLimit, currency, endDate, frequencyType,
                numberOfPayments, requestingOrganisation, creationDate, modificationDate, requestDate, customData, dateCreated,
                dateModified);
    }
