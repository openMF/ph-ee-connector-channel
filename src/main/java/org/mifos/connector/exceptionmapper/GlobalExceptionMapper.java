...
public class GlobalExceptionMapper {
    ...
    public ResponseEntity<GlobalExceptionMapperDTO> handleClientStatusException(ClientStatusException ex) {
        GlobalExceptionMapperDTO exceptionMapperDTO = new GlobalExceptionMapperDTO(PROCESS_DEFINITION_NOT_FOUND.getValue(), PROCESS_DEFINITION_NOT_FOUND.getMessage());
    ...
    public ResponseEntity<GlobalExceptionMapperDTO> handleException(Exception ex) {
        GlobalExceptionMapperDTO exceptionMapperDTO = new GlobalExceptionMapperDTO("01", ex.getMessage());
