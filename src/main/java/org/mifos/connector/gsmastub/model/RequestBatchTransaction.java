...
public class RequestBatchTransaction {
    ...
    public List<RequestTransaction> getTransactions() {
        return transactions;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(batchStatus, transactions, batchTitle, batchdescription, requestingOrganisation, scheduledStartDate,
                modificationDate, requestDate, customData);
    }
