...
public class InternationalTransferInformation {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(quotationReference, quoteId, originCountry, deliveryMethod, receivingCountry, relationshipSender,
                remittancePurpose, sendingServiceProviderCountry);
    }
