...
public class ResponseAccount {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.accountIdentifiers, responseAccount.accountIdentifiers)
                && Objects.equals(this.identity, responseAccount.identity) && Objects.equals(this.accountType, responseAccount.accountType)
                ...
                && Objects.equals(this.currency, responseAccount.currency) && Objects.equals(this.fees, responseAccount.fees)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(accountIdentifiers, identity, accountType, accountStatus, accountSubStatus, currentBalance, availableBalance,
                reservedBalance, unclearedBalance, currency, fees, commissionEarned, registeringEntity, creationDate, modificationDate,
                requestDate, customData);
    }
