...
public class ResponseQuotation {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.quotationReference, responseQuotation.quotationReference)
                ...
                && Objects.equals(this.debitParty, responseQuotation.debitParty) && Objects.equals(this.type, responseQuotation.type)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(quotationReference, creditParty, debitParty, type, subType, quotationStatus, requestAmount, requestCurrency,
                availableDeliveryMethod, chosenDeliveryMethod, originCountry, receivingCountry, quotes, recipientKyc, senderKyc,
                recipientBlockingReason, senderBlockingReason, requestingOrganisation, sendingServiceProviderCountry, creationDate,
                modificationDate, requestDate, dateCreated, dateModified, customData, metadata);
    }
