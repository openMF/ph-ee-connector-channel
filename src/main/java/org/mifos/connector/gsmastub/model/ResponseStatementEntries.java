...
public class ResponseStatementEntries {
    ...
    /**
     * The transaction type that is to be used for presentation to the account holder as determined by the API provider.
     * This is not necessarily the actual transaction type.
     *
     * @return displayType
     **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(transactionReference, creditParty, debitParty, transactionStatus, amount, currency, descriptionText,
                displayType, transactionReceipt, creationDate, modificationDate, requestDate, customData, dateCreated, dateModified);
    }
