...
public class RequestReversal {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.requestingOrganisationTransactionReference, requestReversal.requestingOrganisationTransactionReference)
                ...
                && Objects.equals(this.debitParty, requestReversal.debitParty) && Objects.equals(this.type, requestReversal.type)
                && Objects.equals(this.subType, requestReversal.subType) && Objects.equals(this.amount, requestReversal.amount)
                && Objects.equals(this.currency, requestReversal.currency)
                && Objects.equals(this.descriptionText, requestReversal.descriptionText) && Objects.equals(this.fees, requestReversal.fees)
                ...
                && Objects.equals(this.customData, requestReversal.customData) && Objects.equals(this.metadata, requestReversal.metadata)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(requestingOrganisationTransactionReference, creditParty, debitParty, type, subType, amount, currency,
                descriptionText, fees, geoCode, requestingOrganisation, servicingIdentity, requestDate, customData, metadata, receivingLei,
                requestingLei);
    }
