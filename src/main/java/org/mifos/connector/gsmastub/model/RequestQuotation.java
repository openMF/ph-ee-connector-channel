...
public class RequestQuotation {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.creditParty, requestQuotation.creditParty)
                && Objects.equals(this.debitParty, requestQuotation.debitParty) && Objects.equals(this.type, requestQuotation.type)
                ...
                && Objects.equals(this.customData, requestQuotation.customData) && Objects.equals(this.metadata, requestQuotation.metadata);
    }

    @Override
    public int hashCode() {
        return Objects.hash(creditParty, debitParty, type, subType, requestAmount, requestCurrency, chosenDeliveryMethod, originCountry,
                receivingCountry, recipientKyc, senderKyc, requestingOrganisation, sendingServiceProviderCountry, requestDate, customData,
                metadata);
    }
