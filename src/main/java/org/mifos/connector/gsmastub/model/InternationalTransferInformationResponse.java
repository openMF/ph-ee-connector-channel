...
public class InternationalTransferInformationResponse {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.originCountry, internationalTransferInformationResponse.originCountry)
                ...
                && Objects.equals(this.senderBlockingReason, internationalTransferInformationResponse.senderBlockingReason) && Objects
                        .equals(this.sendingServiceProviderCountry, internationalTransferInformationResponse.sendingServiceProviderCountry);
    }

    @Override
    public int hashCode() {
        return Objects.hash(originCountry, quotationReference, quoteId, deliveryMethod, receivingCountry, relationshipSender,
                remittancePurpose, recipientBlockingReason, senderBlockingReason, sendingServiceProviderCountry);
    }
