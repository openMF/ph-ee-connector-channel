...
public interface BillsApi extends BaseGsmaApi {
    ...
    @Operation(summary = "View Payments for a Bill", description = "This endpoint allows for bill payments for a given bill reference to be returned", tags = {
            "Bills" })
    @ApiResponses(value = {
    ...
    @RequestMapping(value = "/bills/{billReference}/payments", produces = { "application/json" }, method = RequestMethod.GET)
    ResponseEntity<ResponseBillPayment> abillsBillReferencePaymentsGET(
    ...
    @Operation(summary = "Create A Bill Payment", description = "Provided with a valid object representation, this endpoint allows for a new bill payment to be created.", tags = {
            "Bills" })
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "503", description = "Represents an Error Caused by System Unavailability", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorObject.class))) })
    @RequestMapping(value = "/bills/{billReference}/payments", produces = { "application/json" }, consumes = {
            "application/json" }, method = RequestMethod.POST)
    ResponseEntity<ResponseBillPayment> billsBillReferencePaymentsPOST(
            @Size(min = 1, max = 256) @Parameter(in = ParameterIn.PATH, description = "Path variable to uniquely identify a bill.", required = true, schema = @Schema()) @PathVariable("billReference") String billReference,
